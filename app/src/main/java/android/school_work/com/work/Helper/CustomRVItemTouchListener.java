...
public class CustomRVItemTouchListener implements RecyclerView.OnItemTouchListener {
    ...
    private DepartmentsAdapter.RecyclerViewItemClickListener clickListener;

    public CustomRVItemTouchListener(Context context, final RecyclerView recyclerView, final DepartmentsAdapter.RecyclerViewItemClickListener clickListener) {
